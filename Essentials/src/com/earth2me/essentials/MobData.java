...
public enum MobData {
    ...
    PRIEST_VILLAGER("priest", EntityType.VILLAGER, Villager.Profession.CLERIC, true),
    FATHER_VILLAGER("father", EntityType.VILLAGER, Villager.Profession.CLERIC, false),
    SMITH_VILLAGER("smith", EntityType.VILLAGER, Villager.Profession.ARMORER, true),
